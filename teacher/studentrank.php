...
$student_data = array();
$sql = "SELECT p.studentId,q.grade,st.firstName,st.lastName  FROM tblpromoted as p LEFT JOIN (SELECT Id, firstName,lastName FROM tblstudent) as st  ON p.studentId = st.Id LEFT JOIN (SELECT student_id,period,grade,teachingId FROM tblquartergrade) as q ON st.Id = q.student_id WHERE q.teachingId = '".mysqli_real_escape_string($con,$additional_info['id'])."' AND q.period = '".$period."' ORDER BY q.grade DESC";
...
<body>
    <!-- Left Panel -->
    <?php $page="student"; include 'includes/Quarter_menu.php';?>
                ...
                <div class="page-header">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">List of Ranking</a></li>
    ...
    <div class="content">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><h2 align="center">All Student<?php echo $_GET['sectionName']; ?></h2></strong>
                        </div>
                        <div class="card-body">
                            ...
                            <table id="bootstrap-data-table" class="table table-hover table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>FullName</th>
                                        <th><?php echo $additional_info['grading']; ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php 
