...
$query = mysqli_query($con,"SELECT tblpromoted.levelId,s.sessionName,tblstudent.LRN,tblstudent.firstName,tblstudent.age,tblstudent.gender,tblpromoted.sessionId,tblstudent.middleName,tblstudent.lastName,tblpromoted.sectionId,tblpromoted.studentId,tblpromoted.sessionId FROM tblstudent LEFT JOIN tblpromoted ON tblstudent.Id = tblpromoted.studentId
 LEFT JOIN (SELECT Id,sessionName FROM tblsession) as s ON tblpromoted.sessionId = s.Id WHERE tblpromoted.studentId='".$_GET['cardid']."' AND tblpromoted.sessionId = '".$_SESSION['global_session']."'");
...
<div class="main-content">
    ...
    <!-- Content -->
        <div class="content">
            ...
            <div class="bulk">
                <button type="button" name="submit" class="btn "><a class="back" href="../superAdmin/listofstudent.php?viewId=<?php echo $_GET['viewId'];?>" title="View Student Card"><i class="las la-reply" ></i> Back</a></button>
            </div>    
            <?php
                if(!empty($sectionID)){
            ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header">
                            ...
                            <div class="card-title" align="center"><h5>Republic of The Philippines<br> Department of Eduction<br> Region IV-A, Laguna<br> Division of Calamba City<br><b> Majada In Elementary School</b></h5></div>
                        ...
                        <div class="card_body">
                            ...
                            <h4>
                             Dear Parent: <br>
                             &emsp;&emsp;This report card shows the ability and progress your childhas made on the different learning areas as well as his/her core values.<br>
                        ...
                        <div class="table-responsive">
                            <table id="" class="table table-hover table-bordered">
                                <h5><center>REPORT ON LEARNING PROGRESS AND ACHIVEMENT</center></h5>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        WHERE tblstudent.Id ='".$_GET['cardid']."' AND tblpromoted.sessionId = '".$_SESSION['global_session']."' ");
                        ...
                        <div class="table-reponsive">
                                <table  class="table table-hover table-bordered">
                                    <h5><center>REPORT ON A ATTENDANCE</center></h5>
                                        <thead class="table-light">
                                            <tr>
                                                <th>Item</th>
                                                <th>Jan.</th>
