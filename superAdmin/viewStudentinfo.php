...
$student_data = array();
$sql_query = "SELECT * FROM tblpromoted LEFT JOIN (SELECT Id, LRN,firstName,lastName,middleName,father,fathernum,mother,mothernum,guardian,guardiannum FROM tblstudent) as s ON tblpromoted.studentId = s.Id WHERE s.LRN='".mysqli_real_escape_string($con,$_GET['editid'])."'";
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="" name="teacherId" type="text" class="form-control cc-exp" value="<?php echo $rowi['fullName'];?>" Required data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="" disabled>
                                                </div>
                                            </div>
                                        </div>
