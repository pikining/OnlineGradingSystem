...
if(isset($_POST['submit'])){
    ...
    $query=mysqli_query($con,"SELECT * from tblsubject where levelId ='$levelId' and subjectTitle ='$subjectTitle'");
    $ret=mysqli_fetch_array($query);

     if($ret > 0){ //Check the coure Title
      $alertStyle ="alert alert-danger";
      $statusMsg="This Subject already exist in this Grade Level!";

    }
    else{

        $query=mysqli_query($con,"insert into tblsubject(subjectTitle,levelId,semesterId,dateAdded) value('$subjectTitle','$levelId','$semesterId','$dateAdded')");
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="subject" name="subjectTitle" type="text" class="form-control cc-exp" value="" Required data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Subject Title">
                                                    </div>
                                                </div>
                                                    </div>
                                                    <div>
...
<div class="modal fade" id="bulk" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="bulk-form" action="../superAdmin/bulksubject.php" enctype="multipart/form-data"  id="bulk-form" method="POST" >
      <div class="modal-body">
            ...
            <div class="col-12">
                <div class="form-group">
                    <a href="../New_Subject.xlsx" target="_blank" download="template">DOWNLOAD TEMPLATE</a>
                </div>
            </div>
      </div>
